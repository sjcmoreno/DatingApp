...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto) 
        {
            ...
            {
                var connections = await _tracker.GetConnectionForUsers(recipient.UserName);
                if (connections != null)
                {
        ...
        {
            var group = await _unitOfWork.MessageRepository.GetGroupFroConnection(Context.ConnectionId);
